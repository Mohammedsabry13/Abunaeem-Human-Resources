...
(function () {
  ...
  const SERVICE_DATA = {
    air: {
      title: "Recruitment",
      desc: "Finding the best talent for permanent or temporary positions, both within and outside the country, and managing the entire process from job posting to final appointment.",

      image: "assets/image/iStock-1165731864.jpg",
    },
    ocean: {
      title: "Labor supply",
      desc: "Dealing with recruitment agencies to supply labor in all specialties and skills",

      image: "assets/image/tungart7-warehouse-worker-10172906.jpg",
    },
    land: {
      title: "Driving licenses",
      desc: "Obtaining valid driving licenses within the European Union for those with valid EU citizenship or residence permits.",

      image: "assets/image/company-img3.jpg",
    },
    rail: {
      title: "University education",
      desc: "Integrating high school graduates from all scientific and literary disciplines into European universities in all fields of study.",

      image: "assets/image/service-card-img1.jpg",
    },
  };
  ...
  const HERO_SLIDES_DATA = {
    0: {
      title: "We’re building dreams",
      description:
        "Our success comes from a steadfast commitment to the client’s vision and a culture of balance, integrity, leadership and loyalty.",
      buttonText: "Request A Quote",
    },
    1: {
      title: "We have what you're <br /> looking for",
      description:
        "We are proud of the dedication, skill, and integrity of each of our employees, and their unique contributions in building our high-performance teams.",
      buttonText: "Request A Quote",
    },
    2: {
      title: "The ideal source <br /> of skilled labor",
      description:
        "Quality projects delivered on time and on budget. We advise you in every aspect of realizing your sustainable business for the future.",
      buttonText: "Request A Quote",
    },
    // 3: {
